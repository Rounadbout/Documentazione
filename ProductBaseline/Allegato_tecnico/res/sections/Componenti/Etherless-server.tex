...
\begin{figure}[!h]
	\noindent
	\makebox[\textwidth]{\includegraphics[scale=0.4]{././diagrammi/etherless-server/RunRequest.png}}
	\caption{Diagramma di sequenza dell'esecuzione di una funzione Lambda}
\end{figure}
\begin{figure}[!h]
	\noindent
	\makebox[\textwidth]{\includegraphics[scale=0.4]{././diagrammi/etherless-server/DeleteRequest.png}}
	\caption{Diagramma di sequenza dell'eliminazione di una funzione Lambda}
\end{figure}
\begin{figure}[!h]
	\noindent
	\makebox[\textwidth]{\includegraphics[scale=0.32]{././diagrammi/etherless-server/DeployRequest.png}}
	\caption{Diagramma di sequenza del deployment di una funzione Lambda}
\end{figure}
\begin{figure}[!h]
	\noindent
	\makebox[\textwidth]{\includegraphics[scale=0.32]{././diagrammi/etherless-server/EditRequest.png}}
