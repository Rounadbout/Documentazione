...
con la presente il gruppo \Gruppo{} intende comunicarVi ufficialmente la propria partecipazione alla Revisione di Accettazione in data 20 Luglio 2020, allo scopo di esporVi lo stato del prodotto da Voi commissionato, denominato:
  ...
  \begin{itemize}
    \item \AdR{} \textit{v3.0.0} (Esterni/analisi\_dei\_requisiti\_v4.0.0.pdf);
    \item \PdP{} \textit{v3.0.0} (Esterni/piano\_di\_progetto\_v4.0.0.pdf);
    \item \PdQ{} \textit{v3.0.0} (Esterni/piano\_di\_qualifica\_v4.0.0.pdf);
    \item \Glossario{} \textit{v3.0.0} (Esterni/glossario\_v4.0.0.pdf);
		\item \textit{User Manual v0.1.0} (Esterni/user\_manual\_v1.0.0.pdf);
		\item \textit{Developer Manual v0.1.0} (Esterni/developer\_manual\_v1.0.0.pdf);
    \item \NdP{} \textit{v3.0.0} (Interni/norme\_di\_progetto\_v4.0.0.pdf);
    \item \SdF{} \textit{v4.0.0} (Interni/studio\_di\_fattibilità\_v.4.0.0.pdf);
