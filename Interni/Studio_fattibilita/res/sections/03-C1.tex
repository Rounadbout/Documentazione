...
\subsubsection{Aspetti positivi}
	\begin{itemize}
		...
		\item il Proponente\ped{\emph{G}} Zero12 fornisce attività di formazione sulle principali tecnologie AWS\ped{\emph{G}} e Wireframe\ped{\emph{G}}, utilizzate dall’interfaccia della console Web di analisi e controllo dello stato di elaborazione dei video, per la generazione del video di highlights\ped{\emph{G}}.
	\end{itemize}

\subsubsection{Criticità}
	\begin{itemize}
		\item Il Proponente\ped{\emph{G}} non fornisce alcun data-set\ped{\textit{G}} per effettuare il training\ped{\textit{G}} del modello\ped{\emph{G}} di machine learning\ped{\emph{G}}; 
