...
\begin{itemize}
	\item \textbf{Etherless-cli:} è il modulo\ped{\emph{G}} con cui gli sviluppatori interagiscono con Etherless. Supporta diversi comandi, tramite i quali lo sviluppatore può: 
		...
		\end{itemize}  
	A seconda del comando, \textit{Etherless-cli} si occuperà di emettere o rimanere in attesa di un determinato evento\ped{\emph{G}} Ethereum\ped{\emph{G}}. 
	
	\item \textbf{Etherless-smart:} un insieme di Ethereum\ped{\emph{G}} smart-contract\ped{\emph{G}} che gestiscono la comunicazione tra \textit{Etherless-cli} e \textit{Etherless-server}, ed i pagamenti in ETH\ped{\emph{G}} necessari per l'esecuzione delle funzioni; 
...
\subsection{Tecnologie coinvolte}
	\begin{itemize}
		...
		\item \textbf{Solidity:} linguaggio usato per la codifica degli smart-contract\ped{\emph{G}}; 
