\subsection{Capitolato d'appalto C4: Predire in Grafana}
	...
	\begin{itemize}
		...
		\item apprezziamo inoltre la decisione del Proponente di condividere il prodotto\ped{\textit{G}} finale come progetto open-source\ped{\emph{G}}, in modo tale da renderlo disponibile ad un numero sempre maggiore di utenti.
	\end{itemize}
	...
	\subsubsection{Esito}
		Vista la scarsa preparazione dei membri del team nell'ambito dei modelli di apprendimento automatico\ped{\textit{G}}, la relativa complessità degli argomenti trattati e le alte aspettative da parte del Proponente si è deciso di non proporsi per la realizzazione del capitolato\ped{\emph{G}}.