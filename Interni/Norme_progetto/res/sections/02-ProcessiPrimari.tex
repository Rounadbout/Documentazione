\section{Processi Primari}
	...
	\subsection{Sviluppo}
        ...
        \subsubsection{Attività}
          ...
          %  \subsubsection{Produzione di diagrammi UML}
           % Per la produzione dei diagrammi dei casi d'uso è stato scelto lo strumento \textbf{draw.io}. \\ 
           % I file relativi ai diagrammi si trovano nella cartella \texttt{Analisi dei requisiti}, presente in Google Drive. Nello specifico gli Analisti potranno accedervi utilizzando le credenziali dell'account google del gruppo o richiedendo un apposito link di invito. 
