\section{Processi di Supporto}
  \subsection{Documentazione}
    ...
    \subsubsection{Ciclo di vita dei documenti}
      ...
      \begin{itemize}
        \item \textbf{Creazione e strutturazione del documento:} il documento viene creato nella sua directory di appartenenza (secondo le indicazioni nella sezione "Documenti interni ed esterni"), e viene stesa la sua struttura generale. Viene utilizzato un template \LaTeX{} (descritto nella sezione \textsection3.1.5.1);
    ...
    \subsubsection{Documenti presenti}
      ...
      \subsubsubsection{\NdP{}}
        ...
        (Questo stesso documento) Lo scopo delle \textit{\NdP{}} è descritto nella sezione \textsection1.1 "Scopo del Documento"\\
    ...
    \subsubsection{Norme tipografiche}
      ...
      \subsubsubsection{Stile del testo}
        ...
        \begin{itemize}
          ...
          \begin{center}
              \textbf{v[X].[Y].[Z]}
          \end{center}
          (es.: riferendosi ad una sezione specifica "[...] come indicato nella \textsection5.1 dell' \AdR v1.1.0[...]").
        \end{itemize}
      ...
      \subsubsubsection{Sigle e abbreviazioni}
        Nella stesura dei documenti possono essere riferite diverse sigle:
        \begin{itemize}
  ...
  \subsection{Verifica}
    ...
    \subsubsection{Attività}
      ...
      \subsubsubsection{Test}
        Sono la parte costituente dell'Analisi dinamica hanno lo scopo di verificare il corretto funzionamento del codice. I test, per essere ben scritti, devono essere:
        \begin{itemize}
