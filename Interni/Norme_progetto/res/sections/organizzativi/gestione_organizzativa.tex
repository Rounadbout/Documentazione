\subsection{Gestione Organizzativa}
		...
		\subsubsection{Strumenti}
			...
			\subsubsubsection{Zoom}
				Per la gestione delle video-chiamate con il Proponente\ped{\textit{G}} ed il Committente\ped{\textit{G}}, si è scelto di utilizzare l'applicazione \textbf{Zoom}\ped{\textit{G}}.
