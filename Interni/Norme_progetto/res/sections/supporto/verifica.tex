\subsection{Verifica}
    ...
    \subsubsection{Strumenti}
    	...
    	Truffle\ped{\textit{G}} viene fornito di serie con un framework\ped{\textit{G}} di test automatizzato. Viene utilizzato per effettuare il testing di codice Javascript\ped{\textit{G}} e Solidity\ped{\textit{G}}.
    	\begin{center}
