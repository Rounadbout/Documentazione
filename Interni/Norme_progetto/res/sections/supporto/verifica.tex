\subsection{Verifica}
    ...
    \subsubsection{Strumenti}
    	...
    	Jest\ped{\textit{G}} è una piattaforma di test universale, con la capacità di adattarsi a qualsiasi libreria o framework JavaScript.
    	\begin{center}
    		\url{https://jestjs.io/}
    	\end{center}
    	
    	\subsubsubsection{Travis CI}
    	Travis\ped{\textit{G}} è un servizio di integrazione continua utilizzato per testare il nuovo codice caricato nella GitHub.
    	\begin{center}
    		\url{https://travis-ci.org/}
    	\end{center}
    
    	\subsubsubsection{Truffle Test}
    	Truffle\ped{\textit{G}} viene fornito di serie con un framework di test automatizzato. Viene utilizzato per effettuare il test dia di codice Javascript sia di codice Solidity.
    	\begin{center}
