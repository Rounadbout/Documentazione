  \subsection{Gestione della configurazione}
    ...
    \subsubsection{Versionamento}
      ...
      \subsubsubsection{Repository}
        ...
        \end{center}
    	Tale repository\ped{\textit{G}} contiene a sua volta quattro Git submodule, che fanno riferimento alle ultime versioni stabili dei tre moduli di Etherless e della documentazione ufficiale:
    	\begin{center}
