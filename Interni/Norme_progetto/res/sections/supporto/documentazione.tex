\subsection{Documentazione}
	...
	\begin{itemize}
		...
		Lo scopo del \textit{Developer Manual} è di presentare il prodotto nei suoi dettagli implementativi ed architetturali. Si rivolge principalmente a sviluppatori che si occuperanno della manutenzione o di future estensioni del software;
		
		\item \textbf{User Manual}:
		documento ad uso Esterno in lingua inglese.\\
		Lo scopo dello \textit{User Manual} è di presentare il prodotto ad un utilizzatore, trattando nello specifico funzionalità e benefici forniti dall'utilizzo del software sviluppato.
