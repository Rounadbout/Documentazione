...
\subsubsection{Strumenti}
	...
	Infura\ped{\textit{G}} fornisce gli strumenti e l'infrastruttura che consentono agli sviluppatori di portare facilmente la loro applicazione blockchain dai test alla distribuzione su scala, con un accesso semplice e affidabile a Ethereum e IPFS. Viene utilizzato principalmente nell'interazione con la rete test Ropsten.
	\begin{center}
		\url{https://infura.io/}
	\end{center}
	...
	StarUML\ped{\textit{G}} è uno strumento utile alle creazione di diagrammi UML.
	\begin{center}
		\url{http://staruml.io/}
	\end{center}
