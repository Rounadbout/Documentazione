\subsection{Sviluppo}
  ...
  \end{itemize}
    ...
    Questa fase ha come scopo normare l'effettiva realizzazione del prodotto\ped{\textit{G}} software richiesto. In questa fase si concretizza la soluzione architetturale elaborata durante la fase di progettazione, mediante la programmazione vera e propria.    
