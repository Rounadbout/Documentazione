...
\subsubsection{Strumenti}
	...
	Infura\ped{\textit{G}} fornisce gli strumenti e l'infrastruttura, che consentono agli sviluppatori di portare facilmente la loro applicazione blockchain dai test alla distribuzione su scala, con un accesso semplice e affidabile ad Ethereum ed IPFS. Viene utilizzato principalmente nell'interazione con la rete di test Ropsten.
	\begin{center}
		\url{https://infura.io/}
	\end{center}
