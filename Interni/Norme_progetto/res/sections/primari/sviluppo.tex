\subsection{Sviluppo}
  ...
  \end{itemize}
   ...
   \begin{itemize}
	...
	\noindent I componenti \textit{Etherless-cli} ed \textit{Etherless-server} dovranno essere codificati in TypeScript, seguendo la Airbnb JavaScrit Style Guide.. 
...
\subsubsection{Metriche} 
	...
	\subsubsection*{Percentuale dei Requisiti Obbligatori Soddisfatti}
		\begin{itemize}
			...
			\item{\textbf{formula}}: $ PROS = \frac{\#requisiti\_obbligatori\_soddisfatti}{\#requisti\_obbligatori\_totali}$; 
			\item{\textbf{risultato}}: il risultato è compreso tra 0\% e 100\%, in particolare: 
				\begin{itemize}
					\item una valore inferiore al 100\%, indica la presenza di alcuni requisiti obbligatori non soddisfatti; 
	...
	\subsubsubsection{Metriche di progettazione}
		...
		\begin{itemize}
			...
			\item{\textbf{risultato}}: un valore elevato di SFIN è indice di un riutilizzo consistente dellla componente considerata; 
		\end{itemize}
	...
	\begin{itemize}
		\item{\textbf{Descrizione}}: la metrica è indice della complessità di una porzione di codice;  indica il numero di cammini linearmente indipendenti attraverso il grafo di controllo di flusso; 
		\item{\textbf{unità di misura}}: la metrica viene espressa tramite un numero intero; 
	...
	\begin{itemize}
		...
		\item{\textbf{formula}}: $ RCC = \frac{\#linee\_totali}{\#linee\_di\_commento} $. 
	\end{itemize}
	...
	\begin{itemize}
		...
		\item{\textbf{unità di misura}}: la metrica viene espressa tramite un numero intero; 
		\item{\textbf{risultato}}: un numero elevato di attributi denota un carico di responsabilità eccessivo per la classe; 
	\end{itemize}            
