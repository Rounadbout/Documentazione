\subsection{Sviluppo}
	...
	In particolare, l'obiettivo del team è sviluppare un prodotto\ped{\textit{G}} software che superi i test e soddisfi le richieste ed i requisiti fissati dal Proponente\ped{\textit{G}}.
	...
	L'attività di analisi consiste nello studio dei bisogni e delle fonti del dominio applicativo. Ha come obiettivo una modellazione concettuale del sistema mediante l'assegnazione di requisiti a parti distinte del sistema.
     ...
     \begin{itemize}
		...
		\noindent Dove:
		\begin{itemize}
         	\item{\textbf{codice padre}: numero che identifica univocamente i casi d'uso\ped{\textit{G}} di primo livello;}
    ...
    \subsubsubsection{Progettazione}
        ...
        \begin{itemize}
        	...
        	\item{\textbf{Progettazione di Dettaglio}}: vengono svolte operazioni di incremento e di verifica dei documenti redatti; vengono definite le specifiche di dettaglio dell'architettura del prodotto\ped{\textit{G}}, partendo dalla Tecnology Baseline\ped{\textit{G}}. Particolare attenzione viene data alla codifica di tale prodotto\ped{\textit{G}} ed alla creazione di un manuale utente e di un manuale sviluppatore. La Product Baseline\ped{\textit{G}} del progetto si ottiene alla fine di questo periodo;
        \end{itemize}
  ...
  \begin{itemize}
		...
		\item \textbf{PoC\ped{\textit{G}} (Proof of Concept)}: eseguibile funzionale alla dimostrazione dell'adeguatezza delle scelte architetturali;
  \end{itemize}
  ...
  \end{itemize}
    	...
    	\begin{itemize}
    		...
    		\item{\textbf{branch}}\ped{\textit{G}}: tali nodi modellano delle decisioni, vengono indicati tramite dei rombi vuoti e generalmente distinguono due branch\ped{\textit{G}}. Il test che deve essere soddisfatto normalmente viene indicato da un'etichetta posta di fianco al nodo di branch\ped{\textit{G}};
    		\item{\textbf{merge}}: punto in cui i rami generati da un branch\ped{\textit{G}} si uniscono, vengono rappresentati nello stesso modo dei nodi di branch\ped{\textit{G}};
   ...
   \begin{itemize}
         \item{\textbf{indentazione}: i blocchi innestati devono essere correttamente indentati, usando per ciascun livello di indentazione due (2) spazi, fatta eccezione per i commenti. Ogni programmatore dovrà configurare adeguatamente il proprio IDE\ped{\textit{G}} al fine di rispettare tale norma;}
...
\subsubsection{Metriche}
	\subsubsubsection{Metriche di analisi dei requisiti}
		...
		\subsubsection*{Percentuale dei Requisiti Opzionali Soddisfatti}
		\begin{itemize}
...
\subsubsection{Strumenti}
	...
	Si tratta di un Ethereum\ped{\textit{G}} client, con la particolarità di consentire la creazione di una blockchain\ped{\textit{G}} privata finalizzata all'esecuzione di test in locale.
	\begin{center}
		\url{https://www.trufflesuite.com/ganache}
	\end{center}

	\subsubsubsection{Infura}
	Infura\ped{\textit{G}} fornisce gli strumenti e l'infrastruttura, che consentono agli sviluppatori di portare facilmente la loro applicazione blockchain\ped{\textit{G}} dai test alla distribuzione su scala, con un accesso semplice e affidabile ad Ethereum\ped{\textit{G}} ed IPFS\ped{\textit{G}}. Viene utilizzato principalmente nell'interazione con la rete di test Ropsten\ped{\textit{G}}.
	\begin{center}
		\url{https://infura.io/}
	\end{center}

	\subsubsubsection{IPFS}
	IPFS\ped{\textit{G}} è un protocollo e una rete peer-to-peer per l'archiviazione e la condivisione di dati in un file system distribuito. Viene utilizzato per il trasferimento di file ad Etherless-server.
	\begin{center}
		\url{https://ipfs.io/}
	\end{center}
	...
	StarUML\ped{\textit{G}} è uno strumento utile alla creazione di diagrammi UML.
	\begin{center}
		\url{http://staruml.io/}
	\end{center}
	...
	Visual Studio Code$_{G}$ è l'IDE\ped{\textit{G}} scelto per la codifica. Tale scelta è dovuta ai seguenti fattori:
	\begin{itemize}
