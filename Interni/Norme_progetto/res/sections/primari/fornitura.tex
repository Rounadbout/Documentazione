\subsection{Fornitura}
    ...
    \begin{itemize}
       		...
       		\item{\textbf{specifiche dei test}: devono essere definiti nel dettaglio dei test utili al collaudo del prodotto\ped{\textit{G}}, e delle metodologie da implementare per garantire il loro corretto svolgimento;}
