...
\section[E]{\fbox{E}}
	...
	Libreria di Node.js\ped{\textit{G}} che fornisce funzionalità per semplificare la codifica di wallet\ped{\textit{G}} Ethereum\ped{\textit{G}}, la comunicazione con la blockchain\ped{\textit{G}} e con i relativi smart contract\ped{\textit{G}}.
	\subsection*{EVM}
...
\section[Y]{\fbox{Y}}
	\subsection*{Yargs}
	Libreria di Node.js\ped{\textit{G}} che fornisce supporto per l’interpretazione di stringhe JSON\ped{\textit{G}} denominate “optstring”.
\pagebreak
\section[Z]{\fbox{Z}}
	\subsection*{Zoom}
