\section{\fbox{A}}
	...
	\subsection*{API}
	Per application programming interface, si intende un insieme di procedure fornite ai programmatori per supportare lo sviluppo di prodotti\ped{\textit{G}} software. Queste interfacce di elaborazione sono esposte da particolari programmi software, per consentire l’utilizzo delle loro funzionalità.
	\subsection*{API Rest}
	È un sistema di trasmissione dei dati che sfrutta HTTP ed i suoi protocolli.
	\subsection*{Apprendimento approfondito}
	Sottocategoria del machine learning\ped{\textit{G}}, che crea modelli\ped{\textit{G}} di apprendimento su più livelli, basandosi sull’analisi di dati forniti da algoritmi di calcolo statistico.
...
\section{\fbox{B}}
	\subsection*{Back-end}
	È definito di back-end, un programma con il quale l’utente interagisce indirettamente, e che permette l’effettivo funzionamento di un’eventuale interfaccia front-end\ped{\textit{G}}.
...
\section{\fbox{E}}
	...
	\subsection*{EVM}
	Ethereum Virtual Machine, nel contesto di blockchain\ped{\textit{G}}, è il centro di calcolo virtuale che permette l’esecuzione degli smart contracts\ped{\textit{G}}.
...
\section{\fbox{G}}
	...
	\subsection*{GitHub}
	È un servizio di hosting per progetti software, che implementa lo strumento di controllo versione\ped{\textit{G}} distribuito Git\ped{\textit{G}}.
	\subsection*{Gmail}
...
\section{\fbox{I}}
	...
	\subsection*{Issue}
	All'interno del contesto GitHub\ped{\textit{G}}, le issue sono uno strumento virtuale utilizzato per tenere traccia di compiti da portare a termine, aggiornamenti implementare o bug da risolvere di un progetto.
\pagebreak
\section{\fbox{J}}
	\subsection*{Java}
	...
	Linguaggio di programmazione orientato agli oggetti ed agli eventi, comunemente utilizzato nella programmazione Web lato client ed interpretato da browser.
\pagebreak
\section{\fbox{L}}
	\subsection*{\LaTeX{}}
...
\section{\fbox{P}}
	...
	Si tratta di documentazione tecnica, utilizzata per descrivere la configurazione di un prodotto\ped{\textit{G}} software in un determinato momento del suo ciclo di vita.
	\subsection*{Proponente}
	Colui il quale presenta una proposta di capitolato\ped{\textit{G}}, legata ad un progetto da realizzare.
	\subsection*{Pull}
...
\section{\fbox{T}}
	...
	Definisce le tecnologie, i framework\ped{\textit{G}} e le librerie selezionate per lo sviluppo del prodotto.
	\subsection*{Telegram}
	...
	\subsection*{Training}
	Nel contesto del machine learning\ped{\textit{G}}, effettuare il training di un modello\ped{\textit{G}} significa imparare (a determinare) valori adeguati per tutti i pesi ed il bias derivante da esempi già classificati.
	\subsection*{Truffle}
