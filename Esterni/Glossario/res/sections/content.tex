...
\section[D]{\fbox{D}}
	...
	Sono moduli che agiscono come temporaneo sostituto per un modulo chiamante, dando gli stessi output del prodotto\ped{\textit{G}} vero e proprio, oppure per interagendo con sistemi esterni.
\pagebreak
\section[E]{\fbox{E}}
	...
	\subsection*{EVM}
	Ethereum Virtual Machine, nel contesto di blockchain\ped{\textit{G}}, è il centro di calcolo virtuale che permette l’esecuzione degli smart contract\ped{\textit{G}}.
...
\section[T]{\fbox{T}}
	...
	Definisce le tecnologie, i framework\ped{\textit{G}} e le librerie selezionate per lo sviluppo del prodotto\ped{\textit{G}}.
	\subsection*{Telegram}
	...
	\subsection*{Training}
	Nel contesto del machine learning\ped{\textit{G}}, effettuare il training di un modello\ped{\textit{G}} significa imparare (a determinare) valori adeguati per tutti i pesi ed lo sfasamento derivante da esempi già classificati.
	\subsection*{Truffle}
