...
\subsection{Discussione della progettazione del prodotto\ped{\textit{G}} software}
	\paragraph{Modulo Etherless-server}\mbox{}\\
		...
		\begin{itemize}
			...
			\begin{itemize}
				...
				\item possibilità di dare spessore alla funzione che implementa il Framework Serverless\ped{\textit{G}}, inserendovi la gestione delle code Lambda.
			\end{itemize}
		\end{itemize}
	...
	\paragraph{Modulo Etherless-smart}\mbox{}\\
		I membri del gruppo responsabili della progettazione del modulo Etherless-smart hanno esposto dei dubbi su come rappresentare nei diagrammi delle classi le feature caratteristiche del linguaggio Solidity\ped{\textit{G}}:
		\begin{itemize}
