...
\begin{description}
	...
	\item[Funzionamento ambiente locale: ] l'ambiente locale funziona con Ganache oppure Infura, in caso di test lanciare il programma Javascript\ped{\textit{G}} su più shell;
