...
\begin{description}
	...
	\item[Pagamenti:] la scelta della modalitá di pagamento per l'esecuzione di una funzione, tra \textit{escrow} (come da esempio citato nel documento del capitolato\ped{\emph{G}}) e \textit{upfront} (pagamento immediato prima della ricezione del risultato), è lasciata al team. Anche in questo caso devono essere effettuate le opportune valutazioni;
	\item[Gas limit:] come riferimento alla definizione di Gas limit è stato indicato il seguente link \href{https://bitcoin.stackexchange.com/questions/39132/what-is-gas-limit-in-ethereum}{What is Gas limit in Ethereum\ped{\emph{G}}?};
