	...
	\subsubsection{Incrementi}
		\subsubsection{Descrizione}
			\begin{itemize}
				...
				\item \textbf{2$^{\circ}$ Incremento:} progettazione dei 3 moduli\ped{\textit{G}} che compongono il sistema e stesura dell'\textit{Allegato Tecnico 1.0.0};
				\item \textbf{3$^{\circ}$ Incremento:} sviluppo di Etherless-smart;
				\item \textbf{4$^{\circ}$ Incremento:} realizzazione delle componenti Etherless-CLI\ped{\textit{G}} e Etherless-server (comprensivi di test di unitá e di integrazione);\\
