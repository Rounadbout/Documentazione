	...
	\subsubsection{Incrementi}
		\subsubsection{Descrizione}
			\begin{itemize}
				...
				\item \textbf{10$^{\circ}$ Incremento:} progettazione dei 3 moduli\ped{\textit{G}} che compongono il sistema e stesura dell'\textit{Allegato Tecnico 1.0.0};
				\item \textbf{11$^{\circ}$ Incremento:} sviluppo di Etherless-smart;
				\item \textbf{12$^{\circ}$ Incremento:} realizzazione delle componenti Etherless-CLI\ped{\textit{G}} e Etherless-server (comprensivi di test di unitá e di integrazione);\\
