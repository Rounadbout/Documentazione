...
\begin{longtable}{ 
	...
	RT-1 \\ Tecnologie da utilizzare
		...
		&
		\multicolumn{3}{c}{I Proponenti e i componenti del gruppo più esperti hanno condiviso del materiale utile per lo studio di queste tecnologie. Nel caso in cui questo materiale si riveli non sufficiente, i Proponenti si sono resi disponibili a chiarire eventuali dubbi che potrebbero insorgere durante lo sviluppo.} \\
