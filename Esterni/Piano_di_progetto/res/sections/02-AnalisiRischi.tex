...
\begin{longtable}{
	...
	RT-3 \\ Corretta configurazione dell'ambiente di lavoro \\ 
		...
		&
		L'amministratore o altri programmatori che hanno configurato correttamente l'ambiente di sviluppo dovranno aiutare il programmatore che ha riscontrato tale problema per giungere ad una soluzione in tempi brevi.\\
	...
	RO-4 \\ Distribuzione del lavoro disomogenea \\
		...
		È possibile che ad uno o più membri del gruppo sia assegnato un compito troppo oneroso; in questo modo è probabile che si verifichino rallentamenti.
		&
