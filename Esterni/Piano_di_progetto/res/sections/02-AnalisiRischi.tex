...
\begin{longtable}{
	...
	RO-6 \\ Cattiva gestione dell’archivio per la documentazione del progetto \\
		\vspace{5mm} %5mm vertical space
		Probabilità: \textbf{MEDIA} Pericolosità: \textbf{MEDIA} &
		A causa dell'inesperienza dei componenti del gruppo è possibile che alcune funzionalità messe a disposizione dal version control system usato siano poco conosciute. È quindi probabile che si possano verificare problemi ed errori nella gestione del repository\ped{\textit{G}}. 
		&
