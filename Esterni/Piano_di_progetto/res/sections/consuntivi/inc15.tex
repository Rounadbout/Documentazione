\subsubsection{15$^{\circ}$ Incremento}
	...
	A seguito della Product Baseline\ped{\textit{G}} è stato necessario utilizzare delle ore non preventivate per correggere alcuni errori presenti nella progettazione e applicare tali modifiche anche al prodotto\ped{\textit{G}} software. Tale differenza dalla pianificazione è stata limitata dalla riduzione del numero di ore richieste da parte degli Amministratori. 
