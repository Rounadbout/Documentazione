\subsubsection{12$^{\circ}$ Incremento}
	...
	In questo periodo il gruppo si è dedicato principalmente all'implementazione della funzionalità di deployment\ped{\textit{G}} di una funzione all'interno della piattaforma \textit{Etherless}. Essendo una delle funzionalità di maggiore importanza del prodotto\ped{\textit{G}}, il gruppo aveva preventivato un numero di ore di codifica alquanto elevato rispetto agli altri incrementi. 
