...
Il prodotto finale prevede quindi l'integrazione di due tecnologie, Serverless\ped{\textit{G}} e Ethereum\ped{\textit{G}}.\\
...
Lo sviluppatore e l'utente finale interagiscono con il prodotto tramite una CLI\ped{\textit{G}} che prevede alcuni comandi intuitivi che permettono di usufruire di tutte le funzionalità fornite dalla piattaforma.
