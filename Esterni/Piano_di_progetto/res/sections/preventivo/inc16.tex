\subsubsection{16$^{\circ}$ Incremento}
		...
		Durante il sedicesimo incremento la distribuzione oraria preventivata dei ruoli di ogni componente del gruppo sarà la seguente:
		...
		\begin{longtable}{
			...
			\rowcolor{white}\caption {Suddivisione oraria del sedicesimo incremento} \\
		...
		\begin{figure}[H]
			...
			\caption{Suddivisione oraria del sedicesimo incremento}
		\end{figure}
