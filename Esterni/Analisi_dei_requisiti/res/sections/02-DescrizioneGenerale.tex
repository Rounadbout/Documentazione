...
\begin{itemize}
	\item \textbf{Etherless-cli:} interfaccia a linea di comando tramite la quale i vari utenti della piattaforma interagiscono con Etherless; 
...
\begin{itemize}
	...
	\item \textbf{etherless-delete:} eliminazione di una funzione 
	\item \textbf{etherless-logs:} visualizza<ione dei log di esecuzione di una specifica funzione;
...
Viene richiesto che:  
	\begin{itemize}
		...
		\item \textit{Etherless} venga sviluppato utilizzando Typescript 3.6, in particolare facendo riferimento all'approccio di promise/async-await; 
