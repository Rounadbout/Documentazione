...
\begin{itemize}
	...
	\item \textbf{Etherless-server:} si occupa di ascoltare gli eventi trasmessi da \textit{Etherless-smart} e di avviare l'esecuzione delle funzioni così richieste. I risultati ottenuti vengono inviati tramite un ulteriore evento\ped{\textit{G}} nella blockchain\ped{\textit{G}} e mostrati all'utente attraverso \textit{Etherless-cli}\ped{\textit{G}}.
\end{itemize}
