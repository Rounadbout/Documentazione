...
\begin{itemize}
	...
	\item \textbf{Descrizione:} l’utente tenta di eseguire la procedura di autenticazione all’interno della rete Ethereum\ped{\textit{G}} tramite delle credenziali non corrette; il sistema mostra quindi un messaggio di errore;
