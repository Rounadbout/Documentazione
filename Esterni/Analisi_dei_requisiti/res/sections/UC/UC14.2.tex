...
\begin{itemize}
	...
	\item \textbf{Descrizione:} al fine di portare a termine il processo di deploy\ped{\textit{G}} l’utente inserisce il nome della funzione che si vuole pubblicare;  
