...
\begin{itemize}
	...
	\item \textbf{Descrizione:} dopo aver richiesto la creazione di un nuovo account Ethereum\ped{\textit{G}} tramite l’utilizzo del comando \signup{}, l’utente visualizza a video le credenziali del nuovo account creato; 
	...
	\begin{itemize}
		\item \textbf{UC4:} tramite l’utilizzo del flag \texttt{–s} l’utente può richiedere che venga creato nella cartella corrente un file contenente le informazioni del nuovo account Ethereum\ped{\textit{G}} creato.
	\end{itemize}
