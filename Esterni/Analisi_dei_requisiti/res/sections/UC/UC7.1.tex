\subsubsection{UC7.1 - Inserimento mnemonic phrase}
\begin{itemize}
	...
	\begin{itemize}
		\item \textbf{UC7.3:} nel caso di inserimento di una mnemonic phrase\ped{\textit{G}} in formato errato viene mostrato un messaggio di errore. 
	\end{itemize}
