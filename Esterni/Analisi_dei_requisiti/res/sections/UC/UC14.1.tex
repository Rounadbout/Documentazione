...
\begin{itemize}
	...
	\item \textbf{Descrizione:} al fine di portare a termine il processo di deploy\ped{\textit{G}} l’utente inserisce il percorso del file contenente la funzione che si vuole pubblicare;  
