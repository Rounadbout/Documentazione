...
\begin{itemize}
	...
	\item \textbf{Descrizione:} al fine di portare a termine il processo di deploy\ped{\textit{G}} l’utente inserisce la descrizione della funzione che si vuole pubblicare;  
