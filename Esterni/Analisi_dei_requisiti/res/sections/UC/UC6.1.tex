...
\begin{itemize}
	...
	\item \textbf{Scenario principale:} dopo aver deciso di volersi autenticare all’interno della rete Ethereum\ped{\textit{G}} tramite mnemonic phrase\ped{\textit{G}}, l'utente procede all’inserimento di quest’ultima;  
