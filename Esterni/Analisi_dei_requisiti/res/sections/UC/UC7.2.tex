\subsubsection{UC7.2 - Inserimento password}
\begin{itemize}
	...
	\item \textbf{Precondizione:} l’utente ha deciso di autenticarsi tramite uso della propria mnemonic phrase\ped{\textit{G}} e ha già inserito nella CLI\ped{\textit{G}} il comando \texttt{login} seguito dalla mnemonic phrase\ped{\textit{G}}; 
