...
\begin{itemize}
	...
	\begin{itemize}
		\item \textbf{UC5.4:} nel caso di inserimento di una private key\ped{\textit{G}} in formato errato viene mostrato un messaggio di errore.
	\end{itemize}
	\item \textbf{Precondizione:} l’utente ha deciso di autenticarsi tramite uso della propria private key\ped{\textit{G}} e ha già inserito nella CLI\ped{\textit{G}} il comando login seguito dal suo address; 
