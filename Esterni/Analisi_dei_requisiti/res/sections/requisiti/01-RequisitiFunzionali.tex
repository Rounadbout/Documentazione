...
\begin{longtable}{ 
	...
	R2F2.2 & Se il comando di cui si vogliono avere maggiori informazioni non
		è tra quelli messi a disposizione da \textit{Etherless-cli}\ped{\textit{G}} deve essere
	...
	R1F10 & L'utente deve essere in grado di visualizzare tutte le funzioni 
		disponibili in \textit{Etherless} tramite il comando \lista{}. 				& \ob & Capitolato \\ UC13.1 \tabularnewline
