...
\begin{itemize}
	...
	\item{\textbf{fonti}}:   
		\begin{itemize}
			\item \textit{capitolato}: requisito indicato nel capitolato\ped{\textit{G}}; 
			\item \textit{interno}: requisito individuato dagli analisti; 
			\item \textit{caso d'uso}: il requisito è stato estrapolato da uno o più casi d'uso\ped{\textit{G}}. In questo caso vengono riportati gli identificativi dei casi d'uso\ped{\textit{G}} considerati; 
