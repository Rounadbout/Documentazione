...
\begin{longtable}{
	...
	TA1F4.2.1 	& \textbf{R1F4.2.1}: Nel caso in cui l'utente tenti di autenticarsi con una private key in formato errato deve essere mostrato un messaggio di errore. 										& No & No \tabularnewline
	...
	TA2F4.3.1 	& \textbf{R2F4.3.1}: Nel caso in cui l'utente tenti di autenticarsi con una mnemonic phrase in formato errato deve essere mostrato un messaggio di errore. 									& No & No \tabularnewline
