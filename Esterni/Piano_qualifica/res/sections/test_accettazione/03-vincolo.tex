...
\begin{longtable}{ 
	...
	TA1V3 & \textbf{R1V3}: L'applicativo deve essere sviluppato utilizzando TypeScript 3.6\ped{\textit{G}} 	& No & No \tabularnewline
	...
	TA1V4 & \textbf{R1V4}: Il modulo\ped{\textit{G}} \textit{Etherless-server} deve essere implementato 
			utilizzando il Framework Serverless\ped{\textit{G}} 							& No & No \tabularnewline
