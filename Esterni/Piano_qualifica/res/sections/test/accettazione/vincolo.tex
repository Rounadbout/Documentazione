...
\begin{longtable}{ 
	...
	TA1V4 & \textbf{R1V4}: Il modulo\ped{\textit{G}} \textit{Etherless-server} deve essere implementato utilizzando il framework\ped{\textit{G}} Serverless\ped{\textit{G}}.	& No & No \tabularnewline
	TA3V5 & \textbf{R3V5}: Il pagamento deve essere gestito tramite un meccanismo di escrow\ped{\textit{G}}.																	& No & No \tabularnewline
	TA1V6 & \textbf{R1V6}: Deve essere possibile installare \textit{Etherless-cli}\ped{\textit{G}} usando npm\ped{\textit{G}} (node package manager\ped{\textit{G}}).			& No & No \tabularnewline
