...
\subsection{Valutazioni sugli strumenti di lavoro}
	...
	\begin{longtable}{ 
		...
		\textbf{Apprendiento delle tecnologie}: si è rivelato un problema l'insufficiente conoscenza delle tecnologie da utilizzare per sviluppare l'applicativo. Nel dettaglio, queste sono: 		\begin{enumerate}
			...
			\item{AWS\ped{\textit{G}} Elastic Beanstalk;}
			\item{AWS\ped{\textit{G}} Lambda;}
			...
			\item{inquirer.js;}
			\item{Configstore.}
		\end{enumerate} & Si è colmata questa mancanza tramite ricerca personale e studio autonomo. \\
