	...
	\centering
		\begin{tikzpicture} [scale = 0.7]
			\begin{axis}[
				...
				\draw [line width=0.1, red](2020-4-1, 40)--(2020-7-30, 40);
...
\subsubsection*{Correttezza ortografica}
	...
	\begin{longtable}{
		...
		Analisi dei Requisiti & 0 & 0 & 0 & 0 \\
		Glossario & 0 & 0 & 0 & 0 \\
		Norme di Progetto & 0 & 0 & 0 & 0 \\
		Piano di Progetto & 0 & 0 & 0 & 0 \\
		Piano di Qualifica & 0 & 0 & 0 & 0 \\
		Studio di Fattibilità & 0 & 0 & 0 & 0 \\
		Verbali & 0 & 0 & 0 & 0 \\
...
\subsubsection*{Formula di Flesch}
	Nel seguente grafico vengono riportati i valori ottenuti dalla formula di Flesch, calcolati per ogni documento in lingua inglese, in differenti momenti di maturazione del progetto.
		...
		\draw [line width=0.1, red](2020-5-20, 50)--(2020-7-30, 50);
