...
In seguito alla Revisione dei Requisiti, tenutasi in data 2020-04-20, le modifiche apportate ai documenti sono state le seguenti:
	...
	E' stata creata una gerarchia basata su UC4 per il login. Il caso d'uso\ped{\textit{G}} UC10 è stato rinominato in UC9 ed è stato aggiunto un sotto caso, UC9.2, per la visualizzazione dei risultati della list. Il caso d'uso\ped{\textit{G}} UC11.2 è stato estratto da UC11, suddividendo così UC11 in 2 casi d'uso: UC10 e UC11.  L’estensione 11.3 è stata estratta da UC11 ed è stata rinominata in UC12. UC12 è stato rinominato in UC13. UC13 è stato suddiviso in 4 casi d'uso\ped{\textit{G}} separati, ovvero UC20, UC21, UC22, UC23.

	\subsubsection*{Glossario}
	Sono stati inseriti nuovi termini.

	\subsubsection*{Norme di Progetto}
	Sono stati inseriti dei riferimenti alla cura dei rapporti con il Proponente\ped{\textit{G}} nelle attività del processo di fornitura. E' stato inserito il processo di gestione dei cambiamenti tra i processi di supporto. Sono state associate le metriche alle corrispondenti attività.
