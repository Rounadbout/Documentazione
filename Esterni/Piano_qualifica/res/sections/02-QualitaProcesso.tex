...
\subsection{Processi Primari}
	...
	\subsubsection{Processo di Sviluppo}
		...
		\begin{itemize}
			\item{misurazione: $PROS = \displaystyle\frac{\#requisiti\_obbligatori\_soddisfatti}{\#requisti\_obbligatori\_totali} \time 100$;}
...
\subsection{Processi Organizzativi}
	...
	Le metriche usate per la gestione organizzativa sono le seguenti:
		...
		\begin{itemize}
			\item{misurazione: PV = \% di lavoro pianificato $\times$ BAC;}
			\item{valore minimo accettabile: $\geq$ 0;}
			\item{valore preferibile: $\geq$ 0.}
		\end{itemize}
		
		\subsubsubsection*{Actual Cost (AC)}
		Indica il costo effettivamente sostenuto al momento del calcolo.
		\begin{itemize}
			\item{misurazione: numero intero;}
		...
		\begin{itemize}
			\item{misurazione: EV =  \% di lavoro completato $\times$ BAC;}
			\item{valore minimo accettabile: $\geq$ 0;}
			\item{valore preferibile: $\geq$ 0.}
		\end{itemize}
