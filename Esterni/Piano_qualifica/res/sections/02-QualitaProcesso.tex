...
\subsection{Scopo}
Lo scopo della seguente sezione è elencare le metriche adottate dal team \Gruppo{} per valutare la maturità dei processi descritti nel documento \textit{\NdP} e garantire qualità nel loro svolgimento. Lo standard scelto per perseguire tale scopo è ISO/IEC 15504. Inoltre, viene posta particolare attenzione sull'applicazione del metodo di gestione PDCA\ped{\textit{G}} per ricercare un miglioramento continuo nel corso di tutto il progetto didattico.
	...
	\subsubsection{Processo di Sviluppo}
		...
		I valori di riferimento delle metriche usate per l'attività di analisi sono i seguenti:
			\subsubsubsection*{Percentuale dei Requisiti Obbligatori Soddisfatti (PROS)}
				...
				\end{itemize}
			\subsubsubsection*{Percentuale dei Requisiti Desiderabili Soddisfatti (PRDesS)}
				\begin{itemize}
					...
					\item{valore preferibile: 100\%.}
				\end{itemize}
			\subsubsubsection*{Percentuale dei Requisiti Opzionali Soddisfatti (PROpzS)}
				\begin{itemize}
					\item{misurazione: $PROS = \displaystyle\frac{\#requisiti\_opzionali\_soddisfatti}{\#requisti\_opzionali\_totali} \times 100$;}
